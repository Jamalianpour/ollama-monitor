      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const Icon(Icons.bar_chart, color: Colors.deepPurpleAccent, size: 18),
            ...
            Wrap(
              ...
              children: [
                ...
                _Stat('Errors', '${stats.errors}',
                    color: stats.errors > 0 ? Colors.red.shade300 : null),
                if (stats.avgDurationMs != null)
                  _Stat('Avg Latency', '${stats.avgDurationMs!.toStringAsFixed(0)} ms'),
                if (stats.maxDurationMs != null)
                  _Stat('Max Latency', '${stats.maxDurationMs!.toStringAsFixed(0)} ms'),
                      ...
                      child: Row(
                        children: [
                          ...
                          if (m.avgMs != null) ...[
                            ...
                            Text('${m.avgMs!.toStringAsFixed(0)} ms avg',
                                style: const TextStyle(
                                    color: Colors.white38, fontSize: 11)),
                          ],
                        ],
